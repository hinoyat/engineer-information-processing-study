...
- **회복 테스트**: 장애 발생 후 복구 가능성과 복구 시간 등을 검증하는 테스트
- **보안 테스트**: 무단 접근, 데이터 유출 등 보안 위협에 대한 대응력을 평가
- **강도 테스트**: 정상 범위를 초과하는 입력·부하 상황에서의 반응 확인
- **성능 테스트**: 시스템의 응답 시간, 처리량 등 비기능 요구사항을 측정
- **구조 테스트**: 내부 코드·논리 구조에 대한 정확성과 품질 분석
- **회귀 테스트**: 수정 사항이 기존 기능에 영향을 주지 않았는지 확인
- **병행 테스트**: 새로운 시스템과 기존 시스템의 결과를 비교하여 일관성 검증
