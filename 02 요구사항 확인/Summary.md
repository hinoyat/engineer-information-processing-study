...
COCOMO는 개발 규모와 복잡도에 따라 세 가지 유형으로 구분됨:

| 유형 | 적용 대상 | 특징 |
|------|-----------|------|
| **기초형 (Organic)** | 소규모, 단순, 경험 많은 팀 | 간단한 수식, 보정 요소 없음 |
| **중간형 (Semi-Detached)** | 중간 규모, 보통 복잡도 | 기본 수식 + 보정 계수 사용 |
| **내장형 (Embedded)** | 복잡, 대규모, 제약 많은 시스템 | 보정 계수 많고 계산 복잡 |
