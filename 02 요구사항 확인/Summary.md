...
정식 명칭은 **ISO/IEC 15504**이며, CMMI와 유사한 **프로세스 기반 평가 체계**를 제공한다.
...
| 수준 | 설명 |
|------|------|
| **0 - 불완전 수행(Incomplete)** | 프로세스가 거의 수행되지 않음 |
| **1 - 수행됨(Performed)** | 프로세스가 정의 없이 수행됨 |
| **2 - 관리됨(Managed)** | 계획·모니터링·관리되는 프로세스 |
| **3 - 확립됨(Established)** | 조직 표준 프로세스에 따라 수행됨 |
| **4 - 예측됨(Predictable)** | 정량적으로 통제됨 |
| **5 - 최적화됨(Optimizing)** | 지속적인 개선 중심 수행 |

---

#### 🧩 특징 요약

- **국제표준 ISO/IEC 15504에 기반한 평가 모델**
- CMMI와 달리 **각 프로세스마다 개별 평가** 가능
- **능력 수준(Capability Level)** 평가 구조
- **국내외 공공 소프트웨어 사업 입찰 요건**에도 적용됨
...
- 다음 중 SPICE의 **프로세스 평가 기준**이 아닌 것은?
- SPICE는 어떤 국제표준에 해당하는가?

---

#### 🧠 용어 설명

- **SPICE**: 소프트웨어 프로세스 성숙도·능력 평가 모델
- **ISO/IEC 15504**: SPICE의 공식 표준 명칭
- **수행 능력 수준**: 프로세스 성숙도에 따른 0~5단계 평가 체계  
